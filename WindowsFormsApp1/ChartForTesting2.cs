...
{
    public partial class ChartForTesting2 : Form
    {
        public ChartForTesting2(MainForm mf)
        {
            InitializeComponent();
            Set(mf);
        ...
        {
            label1.Text = totalCount.ToString() + @"             " +sp.ElapsedMilliseconds.ToString();
